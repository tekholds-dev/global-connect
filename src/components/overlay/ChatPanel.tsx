...
export function ChatPanel({ eco }: { eco: Ecosystem }) {
  ...
  return (
    <OverlayPanel title={eco.name} subtitle="Community chat · live" accent={eco.color} onClose={() => selectEcosystem(null)} footer={footer}>
      <div ref={listRef} className="flex h-full flex-col gap-3">
